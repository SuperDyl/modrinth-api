...
class ModrinthAuthenticatedApi2(ModrinthApi2):
    ...
    def get_notifications(
        self,
        notification_ids: list[MODRINTH_ID],
    ) -> list[Notification]:
        """
        Gets payout history for your user.
    ...
    def delete_notifications(self, notification_ids: list[MODRINTH_ID]) -> None:
        """
        Delete a notification the user owns.
    ...
    def get_reports(self, report_ids: list[MODRINTH_ID]) -> list[Report]:
        """
        ...
        response = requests.get(
            ...
            headers=self.__get_headers(),
            params={"ids": json.dumps(report_ids)},
        )
        response.raise_for_status()
    ...
    def get_threads(self, thread_ids: list[MODRINTH_ID]) -> list[Thread]:
        """
        ...
        response = requests.get(
            ...
            headers=self.__get_headers(),
            data={"ids": json.dumps(thread_ids)},
        )
        response.raise_for_status()
